...
| Mail | Stub default; Brevo SMTP + custom Correlation header; `notify: false` appends `logs/notifications.log` on System due path; **2–8** workers (default 2); 30s lease + heartbeat; Delivery Webhook adapters |
