...
After a claim, replicate a **lean snapshot** into the outbox payload (ids, `scheduled_at`, `display_offset`, shop name, contact). The mail worker formats that snapshot. It does not hydrate entities again.
