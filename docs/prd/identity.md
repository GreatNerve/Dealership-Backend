...
- Optional **name** on register (and Staff walk-in create). If present, Reminder mail greets `Hi {name},` and Staff Customer GET/list returns it. If omitted, mail has no greeting.
